...
const sicherheitItems = [
  {
    ...
    title: "CO-Warnmelder",
    description:
      "Schutz vor dem unsichtbaren Killer: Kohlenmonoxid. Wir beraten Sie zur optimalen Platzierung und Installation von CO-Warnmeldern.",
  },
  {
    icon: Flame,
    title: "Rauchabzüge",
    description:
      "Regelmäßige Prüfung und Reinigung von Rauchabzügen und Lüftungsanlagen für eine sichere Abgasführung.",
  },
  {
    icon: Home,
  ...
  {
    icon: Shield,
    title: "Brandschutztechnische Prüfung",
